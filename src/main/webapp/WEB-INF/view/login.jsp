                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form:form class="user" method="post" action="checkUser">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="username"
                                                   aria-describedby="username" placeholder="Tên đăng nhập">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input type="checkbox" class="custom-control-input" name="RememberMe" id="customCheck" value="false">
